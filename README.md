...
🗓️ Build start date: Monday, April 20th, 2026

👋 Meet the Team
<div align="center"> <img width="580" height="400" alt="Team" src="https://github.com/user-attachments/assets/24d6e1cf-8024-42e7-bde4-daf8793d4bc1" /> </div>
...
S.E.A.L. Dimensions: Width 10.5cm × Length 17cm × Height 12.5cm  |  Weight: 0.4kg
...
Modular Double Decker Chassis
	
<img width="780" height="780" alt="DoubleDecker" src="https://github.com/user-attachments/assets/5f28c95c-71c9-457d-838c-210cd75169b5" />	We built our initial chassis out of lego, this allowed us to focus on the electronic and coding aspects of our build for the first few days. Lego actually ended up being a good platform to build up from, since we had to make quick adjustments on the fly, all of this while helping us create a modular and organized casing for our electronics.
